...
job "example" {
  ...
  group "cache" {
    ...
    task "redis" {
      ...
      #
      artifact {
        #source = "git::https://github.com/OsvaldasPaulauskas/NomadTutorial/app.zip"
        source = "https://github.com/OsvaldasPaulauskas/NomadTutorial/raw/main/app.zip"
      }
